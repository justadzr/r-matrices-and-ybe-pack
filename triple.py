...
class BDTriple:
    ...
    def passing_orders_with_orientations(self):
        trip = self
        n = trip.n
        T = trip.T
        components = trip.connected_components()
                        ...
                        while in_one_component(i_human, j_human):
                            ...
                            if indicator is None:
                                ...
                                if root_right_to_alpha in record:
                                    ...
                                    #                 ord_from_root_to_beta) == indicator:
                                    #             pr += 1
                                PR[((i+1, j+1), (k_human, l_human), indicator, num)] = pr
                                PL[((i+1, j+1), (k_human, l_human), indicator, num)] = pl
